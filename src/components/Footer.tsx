      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="lg:col-span-2">
            <Link to="/" className="flex items-center mb-4">
              <span className="font-display text-white text-xl font-bold">
                LedgER<span className="text-ledger-400">Pro</span>
              </span>
            </Link>
            <p className="text-gray-400 mb-4 max-w-md">
              A comprehensive double-entry accounting software that streamlines your financial operations with built-in statutory compliance features.
            </p>
        ...
        <div className="pt-8 border-t border-gray-800 md:flex md:items-center md:justify-between">
          <div className="text-sm text-gray-400">
            &copy; {currentYear} LedgER Pro. All rights reserved.
          </div>
